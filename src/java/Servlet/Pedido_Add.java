 ...
 * @author deia_
 */
public class Pedido_Add extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String tipo = "pendente";
        
        dao_carrinho.insere_pedidos(id_usuario, id_produto,tipo);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Pedido_Add.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
