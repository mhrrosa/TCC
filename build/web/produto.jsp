<%-- 
    Document   : produto
    Created on : 06/11/2020, 15:57:19
    Author     : deia_
--%>
...
<html>
    <head>
        ...
        <jsp:forward page="produto_usuario.jsp" />
        <%
                }
            } catch (Exception e) {
                    ...
                    <div class="col-md-12" style="background: rgba(255, 255, 255, 0.5); border-radius: 10px; height: auto;">
                        ...
                        <div class="col-md-6" style="margin-bottom: 30px;">
                            ...
                            <div class="col-md-3" style="">
                               ...
                               <img src="http://<%=ip + ":8080/Web_DriveSuper/" + Mostrar_Produto.foto_1 %>"  style="border-radius: 10px; width: 500px; height: 292px;">
                        ...
                        <div class="col-md-6" style="padding: 10px; margin-bottom: 30px;">
                            ...
                            <p style="background: #ff6565; margin: 20px 0px;">
                               ...
                               <a href="editar_produto.jsp" class="btn btn-danger">Editar</a></p>
